...
<body>
    ...
    if(isset($_POST["nombre"]) && isset($_POST["documento"]) && isset($_POST["celular"]) && isset($_POST["email"])&& isset($_POST["fechaNacimiento"])&& isset($_POST["altura"])&& isset($_POST["peso"])&& isset($_POST["objetivoFitness"])){
        ...
        $query ="INSERT INTO `ingresoususarios` (`id`, `nombre`, `documento`, `celular`, `email`, `fechaNacimiento`, `altura`, `peso`, `objetivoFitness`) VALUES (NULL, '$nombre', '$documento', '$celular', '$email', '$fechaNacimiento', '$altura', '$peso', '$objetivoFitness');";
